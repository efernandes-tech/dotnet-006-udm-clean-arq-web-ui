...
> See the file [package.json](https://github.com/efernandes-tech/dotnet-006-udm-clean-arq-web-ui/blob/main/web/package.json)
...
> See the file [api.csproj](https://github.com/efernandes-tech/dotnet-006-udm-clean-arq-web-ui/blob/main/server/api/api.csproj)
...
> See the file [package.json](https://github.com/efernandes-tech/dotnet-006-udm-clean-arq-web-ui/blob/main/mobile/package.json)

#### **Utilities**

-   Prototype: **[Figma](https://www.figma.com/)** → **[Prototype (CleanArqWebUI)](https://www.figma.com/file/1SxgOMojOB2zYT0Mdk28lB/CleanArqWebUI)**
